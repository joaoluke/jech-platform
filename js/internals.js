...
say(result);`
  ...
  resetSteps() {
    this.steps.forEach((step) => {
      ...
      output.innerHTML =
        '<div class="output-placeholder">Aguardando análise...</div>';
    });
  }
  ...
  async runSyntaxAnalysis(code) {
    ...
    step.classList.add("active");
    output.innerHTML =
      '<div class="output-placeholder">Construindo AST...</div>';
  ...
  async runSemanticAnalysis(code) {
    ...
    step.classList.add("active");
    output.innerHTML =
      '<div class="output-placeholder">Verificando semântica...</div>';
  ...
  async runIRGeneration(code) {
    ...
    step.classList.add("active");
    output.innerHTML =
      '<div class="output-placeholder">Gerando bytecode...</div>';
  ...
  async runExecution(code) {
    ...
    try {
      ...
      html +=
        '<strong style="color: var(--primary);">Saída do Programa:</strong><br><br>';
